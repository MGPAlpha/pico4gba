...
ROM_O := $(OBJ_DIR)/main.o $(OBJ_DIR)/print.o $(OBJ_DIR)/picographics.o $(OBJ_DIR)/cartridge.o $(OBJ_DIR)/$(CARTRIDGE_NAME).o $(OBJ_DIR)/cartdata.o $(OBJ_DIR)/picolib.o $(OBJ_DIR)/picoemu.o
